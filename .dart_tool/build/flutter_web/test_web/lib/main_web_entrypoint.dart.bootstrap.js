...
let modulePaths = {
 ...
 "packages/test_web/main": "packages/test_web/main.ddc",
 "packages/test_web/main_web_entrypoint": "packages/test_web/main_web_entrypoint.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/test_web/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:test_web/main_web_entrypoint.dart") {
          // Clear static caches.
