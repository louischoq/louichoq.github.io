define(['dart_sdk', 'packages/test_web/main'], function(dart_sdk, packages__test_web__main) {
  'use strict';
  ...
  const main = packages__test_web__main.main;
  ...
  dart.trackLibraries("packages/test_web/main_web_entrypoint", {
    "package:test_web/main_web_entrypoint.dart": main_web_entrypoint
  }, {
